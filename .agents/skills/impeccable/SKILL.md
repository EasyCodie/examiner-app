---
name: impeccable
description: Design, audit, polish, or critique frontend UI components and pages. Use when improving UX, visual hierarchy, typography, styling, responsive layouts, or aligning with DESIGN.md.
metadata:
  version: 4.1.3
---
