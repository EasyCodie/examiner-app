...
- **`/impeccable`**: audit, polish, or redesign frontend UI according to `DESIGN.md` (Obsidian Scholar tokens, hairline borders, Cursor Orange highlights, JetBrains Mono typography). Reach for it when polishing components, refining visual hierarchy, or improving interactive fidelity.
