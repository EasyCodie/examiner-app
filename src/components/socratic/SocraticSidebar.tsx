      ...
      <div className="flex-1 p-3.5 overflow-y-auto space-y-3.5 select-text">
        {messages.map((m) => {
          ...
          return (
            ...
            >
              <div
                className={`w-6 h-6 rounded-md flex items-center justify-center shrink-0 mt-0.5 text-xs font-mono-code ${isTutor
              ...
              <div
                className={`max-w-[85%] rounded-xl p-3 text-xs leading-relaxed ${isTutor
