        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <div className="flex items-center gap-0.5 bg-[#141517] p-0.5 rounded-lg border border-white/[0.08] text-[10px] font-mono-code">
            <button
              ...
              className={`px-2 py-1 rounded transition ${filter === 'ALL'
            ...
            <button
              ...
              className={`px-2 py-1 rounded transition ${filter === 'REVIEW'
                  ? 'bg-white/[0.12] text-white font-semibold'
                  : 'text-[#9b9a95] hover:text-[#f3f3f2]'
                }`}
            >
            ...
            <button
              ...
              className={`px-2 py-1 rounded transition ${filter === 'MASTERED'
                  ? 'bg-white/[0.12] text-white font-semibold'
                  : 'text-[#9b9a95] hover:text-[#f3f3f2]'
                }`}
            >
            ...
            <div className="space-y-2">
              {evaluation?.markBreakdown && evaluation.markBreakdown.length > 0 ? (
                evaluation.markBreakdown.map((mb, mIdx) => (
                  <div
                    key={mIdx}
                    className={`p-3 rounded-xl border transition-all text-xs ${mb.awarded
