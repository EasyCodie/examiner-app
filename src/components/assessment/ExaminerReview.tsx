    ...
    <div className="bg-[#efe9de] border border-[#e6dfd8] rounded-2xl overflow-hidden shadow-xl">
      ...
      <div className="p-3 bg-[#faf9f5] border-b border-[#e6dfd8] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 overflow-x-auto">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <div className="flex items-center gap-0.5 bg-[#efe9de] p-1 rounded-lg border border-[#e6dfd8] text-[10px] font-mono-code">
            <button
              type="button"
          ...
          <div className="flex items-center gap-1.5 text-[#706e6a] text-xs font-mono-code">
            <button
              ...
              className="p-1.5 rounded-lg hover:text-[#141413] hover:bg-[#efe9de] disabled:opacity-30 transition"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 min-h-[600px]">
        ...
        <div className="lg:col-span-6 p-6 border-b lg:border-b-0 lg:border-r border-[#e6dfd8] bg-[#faf9f5] flex flex-col">
          ...
          <div className="bg-[#efe9de] p-4 rounded-xl border border-[#e6dfd8] mb-4 text-xs text-[#141413] shadow-2xs">
            ...
            {currentQuestion.diagram?.hasDiagram && currentQuestion.diagram.svgContent && (
              <div className="my-3 p-3 bg-white rounded-lg border border-[#e6dfd8] shadow-sm flex flex-col items-center">
            ...
            {currentQuestion.subparts && currentQuestion.subparts.length > 0 && (
              <div className="mt-3 pt-3 border-t border-[#e6dfd8] space-y-2.5">
          ...
          {/* Submission Preview */}
          <div className="flex-1 bg-white rounded-xl border border-[#e6dfd8] p-4 overflow-y-auto text-slate-900 relative shadow-inner">
